...
Route::group(['middleware' => ['auth'], 'namespace' => '\BinshopsBlog\Controllers'], function () {
...
//            ->name('binshopsblog.view_category');
    ...
    Route::group(['prefix' => config('binshopsblog.admin_prefix', 'blog_admin'), 'middleware' => ['admin']], function () {
